...
export default function Home() {
  ...
  const products = [
    ...
    {
      id: 5,
      name: 'Canopy Membrane',
      image: '/canopy_membrane.jpeg',
      price: '',
      details: [
        'Matrial berkualitas tinggi dengan teknologi membrane terbaru',
        'Desain modern dan elegan untuk berbagai gaya arsitektur',
        'Tahan lama dan ramah lingkungan',
        'Perawatan mudah dengan bahan anti noda dan anti jamur',
        'Intalasi profesional dengan tim berpengalaman'
      ]
    },
    {
      id: 6,
